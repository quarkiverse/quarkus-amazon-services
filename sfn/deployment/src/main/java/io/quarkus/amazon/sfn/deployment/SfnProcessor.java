package io.quarkus.amazon.sfn.deployment;
...
import io.quarkus.amazon.sfn.runtime.SfnConfig;
import io.quarkus.amazon.sfn.runtime.SfnRecorder;
...
public class SfnProcessor extends AbstractAmazonServiceProcessor {
    ...
    void setupApacheSyncTransport(List<RequireAmazonClientTransportBuilderBuildItem> amazonClients, SfnRecorder recorder,
            AmazonClientApacheTransportRecorder transportRecorder,
            SfnConfig runtimeConfig, BuildProducer<AmazonClientSyncTransportBuildItem> syncTransports) {
    ...
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupAwsCrtSyncTransport(List<RequireAmazonClientTransportBuilderBuildItem> amazonClients, SfnRecorder recorder,
    ...
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupUrlConnectionSyncTransport(List<RequireAmazonClientTransportBuilderBuildItem> amazonClients, SfnRecorder recorder,
    ...
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupNettyAsyncTransport(List<RequireAmazonClientTransportBuilderBuildItem> amazonClients, SfnRecorder recorder,
            AmazonClientNettyTransportRecorder transportRecorder,
            SfnConfig runtimeConfig, BuildProducer<AmazonClientAsyncTransportBuildItem> asyncTransports,
    ...
    @BuildStep(onlyIf = AmazonHttpClients.IsAmazonAwsCrtHttpServicePresent.class)
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupAwsCrtAsyncTransport(List<RequireAmazonClientTransportBuilderBuildItem> amazonClients, SfnRecorder recorder,
            AmazonClientAwsCrtTransportRecorder transportRecorder,
    ...
    @BuildStep
    @Record(ExecutionTime.RUNTIME_INIT)
    void createClientBuilders(SfnRecorder recorder,
        ...
        createClientBuilders(
                ...
                syncTransports,
                asyncTransports,
                SfnClientBuilder.class,
                SfnAsyncClientBuilder.class,
                null,
                syntheticBeans,
                clientSync,
                clientAsync,
