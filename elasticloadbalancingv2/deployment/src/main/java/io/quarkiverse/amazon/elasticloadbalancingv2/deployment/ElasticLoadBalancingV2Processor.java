...
public class ElasticLoadBalancingV2Processor extends AbstractAmazonServiceProcessor {
    ...
    @BuildStep
    @Record(ExecutionTime.RUNTIME_INIT)
    void createClientBuilders(ElasticLoadBalancingV2Recorder recorder,
        ...
        createClientBuilders(
                ...
                syncTransports,
                asyncTransports,
                ElasticLoadBalancingV2ClientBuilder.class,
                ElasticLoadBalancingV2AsyncClientBuilder.class,
                null,
                syntheticBeans,
                clientSync,
                clientAsync,
