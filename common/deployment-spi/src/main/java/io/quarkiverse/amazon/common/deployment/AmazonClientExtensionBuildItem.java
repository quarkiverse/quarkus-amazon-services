...
public final class AmazonClientExtensionBuildItem extends MultiBuildItem {
    ...
    private RuntimeValue<HasAmazonClientRuntimeConfig> amazonClientsConfig;
    private final AmazonClientRecorder recorder;
    ...
    public RuntimeValue<SdkPresigner.Builder> getCreatePresignerBuilder() {
        return recorder.createPresignerBuilder();
    }

    public RuntimeValue<AwsClientBuilder> getCreateSyncBuilder(RuntimeValue<SdkHttpClient.Builder> transport) {
        return recorder.createSyncBuilder(transport);
    }

    public RuntimeValue<AwsClientBuilder> getCreateAsyncBuilder(RuntimeValue<SdkAsyncHttpClient.Builder> transport,
            LaunchMode launchMode, Executor executor) {
        return recorder.createAsyncBuilder(transport, launchMode, executor);
    }
}
