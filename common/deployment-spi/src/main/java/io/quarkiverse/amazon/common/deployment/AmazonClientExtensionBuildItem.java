...
public final class AmazonClientExtensionBuildItem extends MultiBuildItem {
    ...
    private final RuntimeValue<AwsSyncClientBuilder<?, ?>> syncBuilder;
    private final RuntimeValue<AwsAsyncClientBuilder<?, ?>> asyncBuilder;
    private final RuntimeValue<SdkPresigner.Builder> presignerBuilder;
    ...
    public AmazonClientExtensionBuildItem(
        ...
        this.syncBuilder = recorder.getSyncBuilder();
        this.asyncBuilder = recorder.getAsyncBuilder();
        this.presignerBuilder = presignerBuilderClass != null ? recorder.createPresignerBuilder() : null;
    }
