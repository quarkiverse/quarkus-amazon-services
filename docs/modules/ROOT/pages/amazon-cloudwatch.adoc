...
== Solution
The application built here allows listing the available Alarms for the provided credentials.
...
In this example, we will create an application that allows us to store and retrieve parameters to and from CloudWatch store using a RESTful API.
