...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-endpoint-override[quarkus.dynamodb."clients".endpoint-override]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-api-call-timeout[quarkus.dynamodb."clients".api-call-timeout]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-api-call-attempt-timeout[quarkus.dynamodb."clients".api-call-attempt-timeout]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-advanced-use-quarkus-scheduled-executor-service[quarkus.dynamodb."clients".advanced.use-quarkus-scheduled-executor-service]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-region[quarkus.dynamodb."clients".aws.region]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-type[quarkus.dynamodb."clients".aws.credentials.type]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-default-provider-async-credential-update-enabled[quarkus.dynamodb."clients".aws.credentials.default-provider.async-credential-update-enabled]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-default-provider-reuse-last-provider-enabled[quarkus.dynamodb."clients".aws.credentials.default-provider.reuse-last-provider-enabled]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-static-provider-access-key-id[quarkus.dynamodb."clients".aws.credentials.static-provider.access-key-id]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-static-provider-secret-access-key[quarkus.dynamodb."clients".aws.credentials.static-provider.secret-access-key]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-static-provider-session-token[quarkus.dynamodb."clients".aws.credentials.static-provider.session-token]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-profile-provider-profile-name[quarkus.dynamodb."clients".aws.credentials.profile-provider.profile-name]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-process-provider-async-credential-update-enabled[quarkus.dynamodb."clients".aws.credentials.process-provider.async-credential-update-enabled]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-process-provider-credential-refresh-threshold[quarkus.dynamodb."clients".aws.credentials.process-provider.credential-refresh-threshold]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-process-provider-process-output-limit[quarkus.dynamodb."clients".aws.credentials.process-provider.process-output-limit]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-process-provider-command[quarkus.dynamodb."clients".aws.credentials.process-provider.command]`
...
`link:#quarkus-amazon-dynamodb_quarkus-dynamodb-aws-credentials-custom-provider-name[quarkus.dynamodb."clients".aws.credentials.custom-provider.name]`
