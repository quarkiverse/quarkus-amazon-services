...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-endpoint-override[quarkus.kinesis."clients".endpoint-override]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-api-call-timeout[quarkus.kinesis."clients".api-call-timeout]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-api-call-attempt-timeout[quarkus.kinesis."clients".api-call-attempt-timeout]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-advanced-use-quarkus-scheduled-executor-service[quarkus.kinesis."clients".advanced.use-quarkus-scheduled-executor-service]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-region[quarkus.kinesis."clients".aws.region]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-type[quarkus.kinesis."clients".aws.credentials.type]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-default-provider-async-credential-update-enabled[quarkus.kinesis."clients".aws.credentials.default-provider.async-credential-update-enabled]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-default-provider-reuse-last-provider-enabled[quarkus.kinesis."clients".aws.credentials.default-provider.reuse-last-provider-enabled]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-static-provider-access-key-id[quarkus.kinesis."clients".aws.credentials.static-provider.access-key-id]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-static-provider-secret-access-key[quarkus.kinesis."clients".aws.credentials.static-provider.secret-access-key]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-static-provider-session-token[quarkus.kinesis."clients".aws.credentials.static-provider.session-token]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-profile-provider-profile-name[quarkus.kinesis."clients".aws.credentials.profile-provider.profile-name]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-process-provider-async-credential-update-enabled[quarkus.kinesis."clients".aws.credentials.process-provider.async-credential-update-enabled]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-process-provider-credential-refresh-threshold[quarkus.kinesis."clients".aws.credentials.process-provider.credential-refresh-threshold]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-process-provider-process-output-limit[quarkus.kinesis."clients".aws.credentials.process-provider.process-output-limit]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-process-provider-command[quarkus.kinesis."clients".aws.credentials.process-provider.command]`
...
`link:#quarkus-amazon-kinesis_quarkus-kinesis-aws-credentials-custom-provider-name[quarkus.kinesis."clients".aws.credentials.custom-provider.name]`
