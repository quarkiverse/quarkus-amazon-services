...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-kinesis_quarkus.kinesis.devservices.container-properties-container-properties]]`link:#quarkus-amazon-kinesis_quarkus.kinesis.devservices.container-properties-container-properties[quarkus.kinesis.devservices.container-properties]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_KINESIS_DEVSERVICES_CONTAINER_PROPERTIES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_KINESIS_DEVSERVICES_CONTAINER_PROPERTIES+++`
endif::add-copy-button-to-env-var[]
--|`Map<String,String>` 
|
