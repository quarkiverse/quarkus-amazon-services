...
a|icon:lock[title=Fixed at build time] [[quarkus-amazon-secretsmanager_quarkus-secretsmanager-devservices-provider]] [.property-path]##link:#quarkus-amazon-secretsmanager_quarkus-secretsmanager-devservices-provider[`+++quarkus.secretsmanager.devservices.provider+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.secretsmanager.devservices.provider+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SECRETSMANAGER_DEVSERVICES_PROVIDER+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SECRETSMANAGER_DEVSERVICES_PROVIDER+++`
endif::add-copy-button-to-env-var[]
--
a|`localstack`, `ministack`, `moto`, `floci`
|

a| [[quarkus-amazon-secretsmanager_quarkus-secretsmanager-config-enabled]] [.property-path]##link:#quarkus-amazon-secretsmanager_quarkus-secretsmanager-config-enabled[`+++quarkus.secretsmanager.config.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.secretsmanager.config.enabled+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether to enable the AWS Secrets Manager ConfigSource (`quarkus.secretsmanager.config`).

When disabled, no configuration values are loaded from AWS Secrets Manager.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SECRETSMANAGER_CONFIG_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SECRETSMANAGER_CONFIG_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a| [[quarkus-amazon-secretsmanager_quarkus-secretsmanager-config-secrets-secrets]] [.property-path]##link:#quarkus-amazon-secretsmanager_quarkus-secretsmanager-config-secrets-secrets[`+++quarkus.secretsmanager.config.secrets."secrets"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.secretsmanager.config.secrets."secrets"+++[]
endif::add-copy-button-to-config-props[]
...
- The map key is the configuration property to expose (for example `my.service.password`). +
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SECRETSMANAGER_CONFIG_SECRETS__SECRETS_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SECRETSMANAGER_CONFIG_SECRETS__SECRETS_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|
...
a| [[quarkus-amazon-secretsmanager_quarkus-secretsmanager-sync-client-crt-connection-acquisition-timeout]] [.property-path]##link:#quarkus-amazon-secretsmanager_quarkus-secretsmanager-sync-client-crt-connection-acquisition-timeout[`+++quarkus.secretsmanager.sync-client.crt.connection-acquisition-timeout+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.secretsmanager.sync-client.crt.connection-acquisition-timeout+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SECRETSMANAGER_SYNC_CLIENT_CRT_CONNECTION_ACQUISITION_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SECRETSMANAGER_SYNC_CLIENT_CRT_CONNECTION_ACQUISITION_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-amazon-secretsmanager_quarkus-secretsmanager[icon:question-circle[title=More information about the Duration format]]
|`+++10S+++`
...
a| [[quarkus-amazon-secretsmanager_quarkus-secretsmanager-async-client-crt-connection-acquisition-timeout]] [.property-path]##link:#quarkus-amazon-secretsmanager_quarkus-secretsmanager-async-client-crt-connection-acquisition-timeout[`+++quarkus.secretsmanager.async-client.crt.connection-acquisition-timeout+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.secretsmanager.async-client.crt.connection-acquisition-timeout+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_SECRETSMANAGER_ASYNC_CLIENT_CRT_CONNECTION_ACQUISITION_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_SECRETSMANAGER_ASYNC_CLIENT_CRT_CONNECTION_ACQUISITION_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-quarkus-amazon-secretsmanager_quarkus-secretsmanager[icon:question-circle[title=More information about the Duration format]]
|`+++10S+++`
