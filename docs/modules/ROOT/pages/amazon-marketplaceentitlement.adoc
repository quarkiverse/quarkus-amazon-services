= Amazon Marketplace Entitlement Client

include::./includes/attributes.adoc[]

Amazon Marketplace Entitlement Service is an API for sellers to submit data for custom usage dimensions. For more information about the necessary permissions to use this API, see https://docs.aws.amazon.com/marketplace/latest/userguide/iam-user-policy-for-aws-marketplace-actions.html[AWS Marketplace metering and entitlement API permissions].

NOTE: The Marketplace Entitlement extension is based on https://docs.aws.amazon.com/sdk-for-java/v2/developer-guide/welcome.html[AWS Java SDK 2.x].
...
include::./includes/quarkus-amazon-marketplaceentitlement.adoc[]
