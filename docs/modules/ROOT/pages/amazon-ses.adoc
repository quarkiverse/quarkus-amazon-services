...
The easiest way to start working with SES is to run a local instance using Dev Services.
...
This command generates a Maven structure importing the RESTEasy Reactive/JAX-RS and Amazon SES Client extensions.
...
include::./includes/quarkus-amazon-ses.adoc[]
