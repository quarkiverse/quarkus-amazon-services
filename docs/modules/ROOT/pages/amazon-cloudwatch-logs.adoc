...
<2> Generate a request to create a log group
<2> Generate a request put log events at a specific log stream and group
<2> Generate a request to list all log events for a specific log stream and group
