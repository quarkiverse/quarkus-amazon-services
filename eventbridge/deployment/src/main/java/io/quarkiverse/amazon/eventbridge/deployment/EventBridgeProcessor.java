...
import io.quarkiverse.amazon.eventbridge.runtime.EventBridgeClientProducer;
...
public class EventBridgeProcessor extends AbstractAmazonServiceProcessor {
    ...
    void setupApacheSyncTransport(List<AmazonClientBuildItem> amazonClients, EventBridgeRecorder recorder,
    ...
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupNettyAsyncTransport(List<AmazonClientBuildItem> amazonClients, EventBridgeRecorder recorder,
    ...
    @BuildStep(onlyIf = AmazonHttpClients.IsAmazonAwsCrtHttpServicePresent.class)
    @Record(ExecutionTime.RUNTIME_INIT)
    void setupAwsCrtAsyncTransport(List<AmazonClientBuildItem> amazonClients, EventBridgeRecorder recorder,
            AmazonClientAwsCrtTransportRecorder transportRecorder,
            BuildProducer<AmazonClientAsyncTransportBuildItem> asyncTransports) {
